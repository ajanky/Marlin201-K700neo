/**
 *
 * 100220  - BTT Filament Rounout Sensor enabled, BabyStepping enabled
 *
...
#define STRING_CONFIG_H_AUTHOR "AJANKY-3BOTS-140520" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "K700neo M201"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // KONG700 - dicke Berta 24Volt + Lueftung
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 102.75  //KONG700 1KW Bed
  #define DEFAULT_bedKi 13.3
  #define DEFAULT_bedKd 529.35
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.5, 107, 640, 476.5 } 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 50, 250 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 18, -1.7 }
...
#define INVERT_E0_DIR true      // original pressured air printhead
...
#define X_BED_SIZE 670
#define Y_BED_SIZE 500  // 670
 ...
 */
#define FILAMENT_RUNOUT_SENSOR   //  BTT Smart Filament Sensor
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600 B3 X350 Y20 Z+20"

  // After a runout is detected, continue printing this length of filament
  // before executing the runout script. Useful for a sensor at the end of
  // a feed tube. Requires 4 bytes SRAM per sensor, plus 4 bytes overhead.
  #define FILAMENT_RUNOUT_DISTANCE_MM 9
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 100), (Y_MAX_POS - 50), 20 }
